...
import com.hanakocz.dwarfworld.tools.GhostSword;
...
public class DwarfGhost extends EntityMob{
	
	public DwarfGhost(World par1World)
	{
		super(par1World);
		experienceValue = 8;
        addRandomArmor();
    ...
    {
        this.entityDropItem(new ItemStack(Items.ender_pearl), 0.0F);
    }
